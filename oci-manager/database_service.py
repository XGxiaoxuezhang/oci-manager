...
def create_autonomous_database_backup(tenant_cfg: dict[str, str], database_id: str, display_name: str) -> str:
    details = oci.database.models.CreateAutonomousDatabaseBackupDetails(
        autonomous_database_id=database_id,
        display_name=(display_name or "").strip() or None,
    )
    response = get_database_client(tenant_cfg).create_autonomous_database_backup(details)
    return getattr(response.data, "id", "")
